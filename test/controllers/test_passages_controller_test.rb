...
class TestPassagesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_passage" do
    assert_difference('TestPassage.count') do
      post test_passages_url, params: { test_passage: { correct_questions: @test_passage.correct_questions, current_question: @test_passage.current_question, refernces: @test_passage.refernces, test: @test_passage.test, user_id: @test_passage.user_id } }
    end
  ...
  test "should update test_passage" do
    patch test_passage_url(@test_passage), params: { test_passage: { correct_questions: @test_passage.correct_questions, current_question: @test_passage.current_question, refernces: @test_passage.refernces, test: @test_passage.test, user_id: @test_passage.user_id } }
